  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <!-- partial -->
        <?php echo $__env->make('opiekun.body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- main-panel ends -->
      </div>
...
<?php /**PATH /Users/magdalenan/laravel_proj/project/resources/views/opiekun/home.blade.php ENDPATH**/ ?>